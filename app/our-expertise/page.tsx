...
import { Droplet, Cpu, ZapIcon, Lightbulb, Gauge, PanelTop } from "lucide-react";
...
const Products: React.FC = () => {
  ...
  return (
    <div className="w-full bg-gray-50">
      ...
      <div id="products-section" className="container mx-auto px-4 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 gap-12 md:gap-16 container mx-auto max-w-6xl">
      ...
      <div className="bg-blue-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href={"/contact"}>
            <Button className=" cursor-pointer px-8 py-3 bg-white text-blue-900 rounded-md font-medium hover:bg-blue-100 transition-colors">
              Contact Our Experts
            </Button>
          </Link>
        </div>
